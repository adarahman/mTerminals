...
class UpstoxSession:
    ...
    def __init__(self, access_token: str | None | object = _TOKEN_UNSET):
        # Omitting the argument consumes the configured environment token;
        # passing None explicitly creates an intentionally empty session.
        self._token = UPSTOX_ACCESS_TOKEN if access_token is _TOKEN_UNSET else access_token
