...
try:  # package-context import, mirrors smartapi_ws_client.py's own try/except
    from .shoonya_client import _session
except ImportError:
    from brokers.shoonya_client import _session
