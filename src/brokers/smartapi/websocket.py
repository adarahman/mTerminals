...
Usage
-----
    from brokers.smartapi.client import _session, get_atm_chain
    from brokers.smartapi.websocket import SmartTickStream
...
from brokers.smartapi.client import _session, API_KEY, CLIENT_CODE
