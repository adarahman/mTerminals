...
window.renderIvSurfaceModal = (...args) => app.chain.renderIvSurfaceModal(...args);
...
window.renderFiiDiiModal = (...args) => app.exec.renderFiiDiiModal(...args);
...
document.addEventListener('DOMContentLoaded', function(){
  ...
  var fiidiiModal = document.getElementById('fiidii-dashboard-modal');
  if(fiidiiModal){
    fiidiiModal.addEventListener('click', function(e){
      if(e.target === fiidiiModal) closeFiiDiiModal();
    });
  }
  var ivSurfaceModal = document.getElementById('iv-surface-modal');
  if(ivSurfaceModal){
    ivSurfaceModal.addEventListener('click', function(e){
      if(e.target === ivSurfaceModal) closeIvSurfaceModal();
    });
  }
});
