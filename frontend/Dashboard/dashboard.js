...
window.openStratPayoffModal = (...args) => app.modal.openStratPayoffModal(...args);
window.closeStratPayoffModal = (...args) => app.modal.closeStratPayoffModal(...args);
window._stratPayoffEscHandler = (...args) => app.modal._stratPayoffEscHandler(...args);
window.openStratPayoffChartModal = (...args) => app.modal.openStratPayoffChartModal(...args);
window.closeStratPayoffChartModal = (...args) => app.modal.closeStratPayoffChartModal(...args);
window._stratPayoffChartEscHandler = (...args) => app.modal._stratPayoffChartEscHandler(...args);
window.openSimGexModal = (...args) => app.modal.openSimGexModal(...args);
window.closeSimGexModal = (...args) => app.modal.closeSimGexModal(...args);
window._simGexEscHandler = (...args) => app.modal._simGexEscHandler(...args);
window.openSimulatorFocusModal = (...args) => app.modal.openSimulatorFocusModal(...args);
window.closeSimulatorFocusModal = (...args) => app.modal.closeSimulatorFocusModal(...args);
window.openVolOiVelocityModal = (...args) => app.modal.openVolOiVelocityModal(...args);
window.closeVolOiVelocityModal = (...args) => app.modal.closeVolOiVelocityModal(...args);
window._volOiVelocityEscHandler = (...args) => app.modal._volOiVelocityEscHandler(...args);
