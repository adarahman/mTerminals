"""Kite Connect (Zerodha) execution adapter — brokers/kite_client.py,
...
try:  # imported as part of the mTerminals package (brokers.kite_execution_adapter)
    from brokers.kite_client import (
        KiteError,
...
except ModuleNotFoundError:  # run standalone/directly with brokers/ as cwd
