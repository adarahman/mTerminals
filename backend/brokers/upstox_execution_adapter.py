"""Upstox execution adapter — brokers/upstox_client.py, shaped for
...
# `brokers.upstox_client` is unambiguous regardless of what else is
...
# (e.g. ws_server_live.py's `from brokers.smartapi_client import ...`).
