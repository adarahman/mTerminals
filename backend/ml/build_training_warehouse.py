...
# ml/features.py yet — the currently deployed models are unaffected.
try:
...
def build_warehouse(
    ...
    for _, g in df.groupby(group_cols):
        ...
        for i in range(len(g) - 1):
            ...
            # ml/features.py, so this has zero effect on the
